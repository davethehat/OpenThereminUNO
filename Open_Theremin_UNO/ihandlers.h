...
extern volatile uint8_t  vol8;               // Volume byte
...
extern volatile uint16_t add_val;         // Table pointer increment
...
inline void setWavetableSampleAdvance(uint16_t val) { add_val = val;}
